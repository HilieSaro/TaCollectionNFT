...
<head>
  ...
  <style>
    ...
    header { padding: 1rem; display: flex; justify-content: space-between; background: rgba(0,0,0,.55); border-bottom: 1px solid rgba(255,255,255,.1); }
    ...
    .card img { width: 100%; aspect-ratio: 1/1; object-fit: cover; border-bottom: 1px solid rgba(255,255,255,.12); }
    .meta { padding: 1rem; }
